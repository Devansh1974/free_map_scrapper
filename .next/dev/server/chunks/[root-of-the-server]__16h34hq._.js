...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$enrichment$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/enrichment.ts [app-route] (ecmascript)");
;
;
;
;
...
const searchSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    enrich: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].preprocess((val)=>val === "true" || val === true, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean()).default(false)
});
async function GET(request) {
    try {
        ...
        let results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$google$2d$places$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchGooglePlaces"])({
            query,
            location,
            limit
        });
...
"[project]/src/lib/enrichment.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function extractLinksAndEmails(html, baseUrl) {
    ...
    $("a[href]").each((_, el)=>{
        ...
        // Instagram check
        if (/instagram\.com\//i.test(fullUrl) && !/instagram\.com\/(p|reel|tv|stories|share|intent|dialog)/i.test(fullUrl)) {
            if (!instagram) instagram = fullUrl;
        }
        // Facebook check
        if (/(facebook\.com|fb\.com)\//i.test(fullUrl) && !/(facebook\.com|fb\.com)\/(sharer|share|plugins|dialog)/i.test(fullUrl)) {
        ...
        const isContactLink = /contact/i.test(href) || /contact/i.test(linkText) || /about/i.test(href) || /support/i.test(href);
...
async function enrichBusinessResult(business) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16h34hq._.js.map